...
class Account
{
    ...
    double moneyWithdraw(double money) throws moneyWithdrawException
    {
...
public class Main
{
	public static void main(String[] args) throws moneyWithdrawException {
		Account myaccount = new Account(001, 1000.0, 19);
		double newbalance = myaccount.moneyDeposit(1000.0);
		newbalance = myaccount.moneyWithdraw(3000.0);
